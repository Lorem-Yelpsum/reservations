...
const Summary = ({price_range, health_score, opening, closing}) => {
  let price_scale = {
  ...
  let isOpen = moment().isBetween(moment(opening, 'hh:mm:ss'), moment(closing, 'hh:mm:ss'));
          ...
          <li>
            ...
            <div styleName="li-underline li-description">
              <dl>
                <dt>Today</dt>
                <dd>
                  <span>{`${moment(opening, 'hh:mm:ss').format('h:mm a')} - ${moment(closing, 'hh:mm:ss').format('h:mm a')}`}</span>
                  &nbsp;
